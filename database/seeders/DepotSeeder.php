...
class DepotSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('depots')->insert([
            ...
            'address' => 'Jalan Mohammad Hatta, Padang, Sumatera Barat, 25162, Pauh Padang Indonesia',
            'price' => 5000,
            'is_open' => true
        ]);
        ...
        DB::table('depots')->insert([
            ...
            'address' => 'Jalan Malintang, Padang, Sumatera Barat, 25162, Pauh Padang Indonesia',
            'price' => 5000,
            'is_open' => true
        ]);
